                        ...
                        <div className="container-fluid">
                            <nav className="nav background-white ">
                                <div className="adminx-main-content">
                                    ...
                                    <button className="btn-petbook mt-2" onClick={cancelEvent}>Cancel</button>
                                    <button className="btn-petbook ml-4" data-toggle="modal" data-target="#createFunction">Modify</button>
                                </div>
                            </nav>
                        </div>
